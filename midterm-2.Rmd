...
#as.numeric(!is.na(hwGrades$))
#hwGrades$交作業次數 <- !is.na(hwGrades$hw1)+
#  !is.na(hwGrades$hw2)+!is.na(hwGrades$Exercise3)
```
...
```{r ans18}
mean(hwGradesSubsample[(hwGradesSubsample$女性==FALSE),]$平均成績)
```
...
cbind(aa,with_tz(aa,tzone="Asia/Taipei"))
```
